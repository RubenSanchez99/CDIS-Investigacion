...
ASP.NET Core se maneja de manera similar a ASP.NET MVC en el .NET Framework original. Para definir las rutas de la API de nuestro microservicio, creamos clases controller.
